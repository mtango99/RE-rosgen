...
CrossProf <- read.csv("../../data/derived/public/crossprof3.txt", header=FALSE, sep = " ", col.names=c("Junk","Distance","Elevation"))[c(2,3)]
...
DpthBf_Max <- 0.8979 # Insert the maximum bankfull depth from your point/reach of interest here, replacing the 8 left of the hash #
...
ggplot(CrossProf) +
       ...
       ylim(1240,1320) + # Sets the y-axis limits. Adjust this value as you zoom in to the correct area.
       scale_color_gradient(low = "green", high = "brown") +
